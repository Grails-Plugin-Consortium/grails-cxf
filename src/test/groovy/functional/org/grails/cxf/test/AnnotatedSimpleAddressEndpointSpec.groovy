...
class AnnotatedSimpleAddressEndpointSpec extends GebReportingSpec {

    SOAPClient client = new SOAPClient("http://localhost:${System.getProperty("server.port", "8080")}/grails-cxf/services/v2/annotatedSimpleAddress")
